...
ma: main.o $(OBJS)
	g++ -g $(KEYS) -o ma main.o $(OBJS)

cache: with_cache.o $(OBJS)
	g++ -g $(KEYS) -o cache with_cache.o $(OBJS)
...
analyzed_word.o: analyzer/analyzed_word.cpp
	g++ $(KEYS) -g -c analyzer/analyzed_word.cpp

lemmas_rules.o: analyzer/lemmas_rules.cpp
	g++ $(KEYS) -g -c analyzer/lemmas_rules.cpp

endings_rules.o: analyzer/endings_rules.cpp
	g++ $(KEYS) -g -c analyzer/endings_rules.cpp

rules.o: analyzer/rules.cpp
	g++ $(KEYS) -g -c analyzer/rules.cpp

forms.o: analyzer/forms.cpp
	g++ $(KEYS) -g -c analyzer/forms.cpp

word_infos.o: analyzer/word_infos.cpp
	g++ $(KEYS) -g -c analyzer/word_infos.cpp

normal_forms.o: analyzer/normal_forms.cpp
	g++ $(KEYS) -g -c analyzer/normal_forms.cpp
